...
const morningPrayer: ServiceDefinition = {
  ...
  sections: [
    ...
    { id: 'sermon', title: 'Reflection', kind: 'sermon', role: 'officiant', optional: true, note: 'A short reflection or address (see Settings for who may give one).' },
...
const serviceOfTheWord: ServiceDefinition = {
  ...
  sections: [
    ...
    { id: 'sermon', title: 'Reflection', kind: 'sermon', role: 'officiant', optional: true },
