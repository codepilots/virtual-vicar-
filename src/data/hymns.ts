...
export interface Tune {
   ...
   * Hymnal Project — see public/midi/CREDITS.md for per-tune credits). Being
   * same-origin it embeds in the player and works offline; cross-origin MIDI
   * is never embedded (CORS-blocked on a static host) — tunes without a
   * bundled file get a listen link instead.
   */
  midiFile?: string;
}
...
// credits. `listenUrl` points at Hymnary.org tune pages for listening;
// tunes with neither get a YouTube search link instead.
export const HYMNS: Hymn[] = [
  ...
  // ---- Passiontide ----
  { id: 'when-i-survey', title: 'When I survey the wondrous cross', firstLine: 'When I survey the wondrous cross', verses: 4, seasons: ['Passiontide', 'Lent'], congregations: [], tunes: [{ id: 'rockingham', name: 'Rockingham', metre: 'LM', midiFile: 'rockingham.mid', listenUrl: 'https://hymnary.org/tune/rockingham_miller' }], numbers: { neh: 95, am: 157, mp: 755 } },
  ...
  { id: 'crown-him', title: 'Crown him with many crowns', firstLine: 'Crown him with many crowns', verses: 5, seasons: ['Easter', 'Ordinary Time after Trinity'], congregations: [], tunes: [{ id: 'diademata', name: 'Diademata', metre: 'DSM', midiFile: 'diademata.mid', listenUrl: 'https://hymnary.org/tune/diademata_elvey' }], numbers: { neh: 352, am: 228, mp: 109 } },
  // ---- Pentecost ----
  ...
  // ---- Trinity ----
  { id: 'holy-holy-holy', title: 'Holy, holy, holy', firstLine: 'Holy, holy, holy! Lord God Almighty', verses: 4, seasons: ['Ordinary Time after Trinity'], congregations: [], tunes: [{ id: 'nicaea', name: 'Nicaea', metre: '11.12.12.10', midiFile: 'nicaea.mid', listenUrl: 'https://hymnary.org/tune/nicaea_dykes' }], numbers: { neh: 146, am: 245, cp: 187 } },
  // ---- Ascension & sacrament ----
  ...
  { id: 'guide-me', title: 'Guide me, O thou great Redeemer', firstLine: 'Guide me, O thou great Redeemer', verses: 3, seasons: [], congregations: [], tunes: [{ id: 'cwm-rhondda', name: 'Cwm Rhondda', metre: '87.87.47', midiFile: 'cwm-rhondda.mid', listenUrl: 'https://hymnary.org/tune/cwm_rhondda' }], numbers: { neh: 368, mp: 201 } },
  ...
  // ---- Evening ----
  { id: 'abide-with-me', title: 'Abide with me', firstLine: 'Abide with me; fast falls the eventide', verses: 5, seasons: [], congregations: [], tunes: [{ id: 'eventide', name: 'Eventide (Monk)', metre: '10.10.10.10', midiFile: 'eventide.mid', listenUrl: 'https://hymnary.org/tune/eventide_monk' }], numbers: { neh: 331, mp: 4 } },
