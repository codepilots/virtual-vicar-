...
// `midiUrl` points at Hymnary.org tune pages where a MIDI is commonly
// available; tunes without one get a search link instead.
export const HYMNS: Hymn[] = [
  ...
  // ---- Christmas ----
  { id: 'o-come-all-ye-faithful', title: 'O come, all ye faithful', firstLine: 'O come, all ye faithful', verses: 6, hasChorus: true, seasons: ['Christmas'], congregations: [], tunes: [{ id: 'adeste-fideles', name: 'Adeste Fideles', metre: 'Irregular', midiUrl: 'https://hymnary.org/tune/adeste_fideles_wade' }], numbers: { neh: 30, am: 78, mp: 487 } },
  ...
  // ---- Passiontide ----
  { id: 'when-i-survey', title: 'When I survey the wondrous cross', firstLine: 'When I survey the wondrous cross', verses: 4, seasons: ['Passiontide', 'Lent'], congregations: [], tunes: [{ id: 'rockingham', name: 'Rockingham', metre: 'LM', midiUrl: 'https://hymnary.org/tune/rockingham_miller' }], numbers: { neh: 95, am: 157, mp: 755 } },
  ...
  // ---- Easter ----
  { id: 'jesus-christ-is-risen-today', title: 'Jesus Christ is risen today', firstLine: 'Jesus Christ is risen today, Alleluia!', verses: 4, seasons: ['Easter'], congregations: [], tunes: [{ id: 'easter-hymn', name: 'Easter Hymn', metre: '77.77 with Alleluias', midiUrl: 'https://hymnary.org/tune/easter_hymn' }], numbers: { neh: 110, am: 169, mp: 357 } },
  ...
  { id: 'crown-him', title: 'Crown him with many crowns', firstLine: 'Crown him with many crowns', verses: 5, seasons: ['Easter', 'Ordinary Time after Trinity'], congregations: [], tunes: [{ id: 'diademata', name: 'Diademata', metre: 'DSM', midiUrl: 'https://hymnary.org/tune/diademata_elvey' }], numbers: { neh: 352, am: 228, mp: 109 } },
  // ---- Pentecost ----
  ...
  // ---- Trinity ----
  { id: 'holy-holy-holy', title: 'Holy, holy, holy', firstLine: 'Holy, holy, holy! Lord God Almighty', verses: 4, seasons: ['Ordinary Time after Trinity'], congregations: [], tunes: [{ id: 'nicaea', name: 'Nicaea', metre: '11.12.12.10', midiUrl: 'https://hymnary.org/tune/nicaea_dykes' }], numbers: { neh: 146, am: 245, cp: 187 } },
  // ---- Harvest ----
  ...
  // ---- General praise ----
  { id: 'praise-to-the-lord', title: 'Praise to the Lord, the Almighty', firstLine: 'Praise to the Lord, the Almighty, the King of creation', verses: 4, seasons: [], congregations: [], tunes: [{ id: 'lobe-den-herren', name: 'Lobe den Herren', metre: '14.14.4.7.8', midiUrl: 'https://hymnary.org/tune/lobe_den_herren' }], numbers: { neh: 440, mp: 564 } },
  ...
  { id: 'guide-me', title: 'Guide me, O thou great Redeemer', firstLine: 'Guide me, O thou great Redeemer', verses: 3, seasons: [], congregations: [], tunes: [{ id: 'cwm-rhondda', name: 'Cwm Rhondda', metre: '87.87.47', midiUrl: 'https://hymnary.org/tune/cwm_rhondda' }], numbers: { neh: 368, mp: 201 } },
  ...
  { id: 'all-people-that-on-earth', title: 'All people that on earth do dwell', firstLine: 'All people that on earth do dwell', verses: 5, seasons: [], congregations: ['traditional', 'cathedral', 'small-rural'], tunes: [{ id: 'old-hundredth', name: 'Old Hundredth', metre: 'LM', midiUrl: 'https://hymnary.org/tune/old_hundredth' }], numbers: { neh: 334, mp: 20 } },
  ...
  // ---- Evening ----
  { id: 'abide-with-me', title: 'Abide with me', firstLine: 'Abide with me; fast falls the eventide', verses: 5, seasons: [], congregations: [], tunes: [{ id: 'eventide', name: 'Eventide (Monk)', metre: '10.10.10.10', midiUrl: 'https://hymnary.org/tune/eventide_monk' }], numbers: { neh: 331, mp: 4 } },
