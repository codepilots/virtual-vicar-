...
// `listenUrl` points at a Hymnary.org tune page (opened as a link, where the
// tune can be heard); tunes without one fall back to a YouTube search.
export const HYMNS: Hymn[] = [
  // ---- Advent ----
  { id: 'come-thou-long-expected', title: 'Come, thou long expected Jesus', firstLine: 'Come, thou long expected Jesus', verses: 2, seasons: ['Advent'], congregations: [], tunes: [{ id: 'cross-of-jesus', name: 'Cross of Jesus', metre: '87.87', listenUrl: 'https://hymnary.org/tune/cross_of_jesus_stainer' }, { id: 'stuttgart', name: 'Stuttgart', metre: '87.87' }], numbers: { neh: 3, am: 32 } },
  { id: 'o-come-o-come-emmanuel', title: 'O come, O come, Emmanuel', firstLine: 'O come, O come, Emmanuel', verses: 5, hasChorus: true, seasons: ['Advent'], congregations: [], tunes: [{ id: 'veni-emmanuel', name: 'Veni Emmanuel', metre: '88.88 with refrain' }], numbers: { neh: 11, am: 39, mp: 493 } },
  { id: 'lo-he-comes', title: 'Lo! he comes with clouds descending', firstLine: 'Lo! he comes with clouds descending', verses: 4, seasons: ['Advent'], congregations: [], tunes: [{ id: 'helmsley', name: 'Helmsley', metre: '87.87.47' }], numbers: { neh: 9, am: 34 } },
  ...
  { id: 'on-jordans-bank', title: 'On Jordan’s bank the Baptist’s cry', firstLine: 'On Jordan’s bank the Baptist’s cry', verses: 5, seasons: ['Advent'], congregations: [], tunes: [{ id: 'winchester-new', name: 'Winchester New', metre: 'LM' }], numbers: { neh: 12, am: 36 } },
  // ---- Christmas ----
  { id: 'o-come-all-ye-faithful', title: 'O come, all ye faithful', firstLine: 'O come, all ye faithful', verses: 6, hasChorus: true, seasons: ['Christmas'], congregations: [], tunes: [{ id: 'adeste-fideles', name: 'Adeste Fideles', metre: 'Irregular', listenUrl: 'https://hymnary.org/tune/adeste_fideles_wade' }], numbers: { neh: 30, am: 78, mp: 487 } },
  { id: 'hark-the-herald', title: 'Hark! the herald-angels sing', firstLine: 'Hark! the herald-angels sing', verses: 3, seasons: ['Christmas'], congregations: [], tunes: [{ id: 'mendelssohn', name: 'Mendelssohn', metre: '77.77 D with refrain' }], numbers: { neh: 26, am: 80, mp: 211 } },
  ...
  { id: 'o-little-town', title: 'O little town of Bethlehem', firstLine: 'O little town of Bethlehem', verses: 4, seasons: ['Christmas'], congregations: [], tunes: [{ id: 'forest-green', name: 'Forest Green', metre: 'DCM' }], numbers: { neh: 32, am: 86 } },
  { id: 'silent-night', title: 'Silent night', firstLine: 'Silent night, holy night', verses: 3, seasons: ['Christmas'], congregations: [], tunes: [{ id: 'stille-nacht', name: 'Stille Nacht', metre: 'Irregular' }], numbers: { am: 87, mp: 602 } },
  { id: 'in-the-bleak-midwinter', title: 'In the bleak mid-winter', firstLine: 'In the bleak mid-winter', verses: 4, seasons: ['Christmas'], congregations: [], tunes: [{ id: 'cranham', name: 'Cranham (Holst)', metre: 'Irregular' }, { id: 'darke', name: 'Darke' }], numbers: { neh: 28 } },
  { id: 'joy-to-the-world', title: 'Joy to the world', firstLine: 'Joy to the world! the Lord is come', verses: 4, seasons: ['Christmas'], congregations: ['contemporary', 'all-age', 'family'], tunes: [{ id: 'antioch', name: 'Antioch', metre: 'CM' }], numbers: { mp: 393 } },
  // ---- Epiphany ----
  { id: 'as-with-gladness', title: 'As with gladness men of old', firstLine: 'As with gladness men of old', verses: 5, seasons: ['Epiphany'], congregations: [], tunes: [{ id: 'dix', name: 'Dix', metre: '77.77.77' }], numbers: { neh: 47, am: 98 } },
  ...
  { id: 'songs-of-thankfulness', title: 'Songs of thankfulness and praise', firstLine: 'Songs of thankfulness and praise', verses: 4, seasons: ['Epiphany'], congregations: ['traditional', 'cathedral'], tunes: [{ id: 'st-edmund', name: 'St Edmund', metre: '77.77 D' }], numbers: { neh: 56 } },
  // ---- Lent ----
  ...
  { id: 'lord-jesus-think-on-me', title: 'Lord Jesus, think on me', firstLine: 'Lord Jesus, think on me', verses: 4, seasons: ['Lent'], congregations: [], tunes: [{ id: 'southwell', name: 'Southwell', metre: 'SM' }], numbers: { neh: 70 } },
  ...
  // ---- Passiontide ----
  { id: 'when-i-survey', title: 'When I survey the wondrous cross', firstLine: 'When I survey the wondrous cross', verses: 4, seasons: ['Passiontide', 'Lent'], congregations: [], tunes: [{ id: 'rockingham', name: 'Rockingham', metre: 'LM', listenUrl: 'https://hymnary.org/tune/rockingham_miller' }], numbers: { neh: 95, am: 157, mp: 755 } },
  ...
  { id: 'ride-on-ride-on', title: 'Ride on, ride on in majesty', firstLine: 'Ride on! ride on in majesty!', verses: 5, seasons: ['Passiontide'], congregations: [], tunes: [{ id: 'winchester-new-rideon', name: 'Winchester New', metre: 'LM' }], numbers: { neh: 511, am: 161 } },
  { id: 'o-sacred-head', title: 'O sacred head, sore wounded', firstLine: 'O sacred head, sore wounded', verses: 4, seasons: ['Passiontide'], congregations: ['traditional', 'cathedral'], tunes: [{ id: 'passion-chorale', name: 'Passion Chorale', metre: '76.76 D' }], numbers: { neh: 90, am: 152 } },
  // ---- Easter ----
  { id: 'jesus-christ-is-risen-today', title: 'Jesus Christ is risen today', firstLine: 'Jesus Christ is risen today, Alleluia!', verses: 4, seasons: ['Easter'], congregations: [], tunes: [{ id: 'easter-hymn', name: 'Easter Hymn', metre: '77.77 with Alleluias', listenUrl: 'https://hymnary.org/tune/easter_hymn' }], numbers: { neh: 110, am: 169, mp: 357 } },
  { id: 'thine-be-the-glory', title: 'Thine be the glory', firstLine: 'Thine be the glory, risen, conquering Son', verses: 3, hasChorus: true, seasons: ['Easter'], congregations: [], tunes: [{ id: 'maccabaeus', name: 'Maccabaeus', metre: '10.11.11.11', listenUrl: 'https://hymnary.org/tune/maccabaeus_handel' }], numbers: { neh: 120, am: 218, mp: 689 } },
  ...
  { id: 'the-day-of-resurrection', title: 'The day of resurrection', firstLine: 'The day of resurrection! Earth, tell it out abroad', verses: 3, seasons: ['Easter'], congregations: ['traditional', 'cathedral'], tunes: [{ id: 'ellacombe', name: 'Ellacombe', metre: '76.76 D' }], numbers: { neh: 117, am: 208 } },
  // ---- Ascension ----
  { id: 'hail-the-day', title: 'Hail the day that sees him rise', firstLine: 'Hail the day that sees him rise, Alleluia!', verses: 5, seasons: ['Easter'], congregations: [], tunes: [{ id: 'llanfair', name: 'Llanfair', metre: '77.77 with Alleluias' }], numbers: { neh: 130, am: 222 } },
  { id: 'crown-him', title: 'Crown him with many crowns', firstLine: 'Crown him with many crowns', verses: 5, seasons: ['Easter', 'Ordinary Time after Trinity'], congregations: [], tunes: [{ id: 'diademata', name: 'Diademata', metre: 'DSM', listenUrl: 'https://hymnary.org/tune/diademata_elvey' }], numbers: { neh: 352, am: 228, mp: 109 } },
  // ---- Pentecost ----
  ...
  // ---- Trinity ----
  { id: 'holy-holy-holy', title: 'Holy, holy, holy', firstLine: 'Holy, holy, holy! Lord God Almighty', verses: 4, seasons: ['Ordinary Time after Trinity'], congregations: [], tunes: [{ id: 'nicaea', name: 'Nicaea', metre: '11.12.12.10', listenUrl: 'https://hymnary.org/tune/nicaea_dykes' }], numbers: { neh: 146, am: 245, cp: 187 } },
  // ---- Harvest ----
  ...
  { id: 'come-ye-thankful-people', title: 'Come, ye thankful people, come', firstLine: 'Come, ye thankful people, come', verses: 4, seasons: ['Ordinary Time after Trinity'], congregations: [], tunes: [{ id: 'st-george-windsor', name: 'St George’s Windsor', metre: '77.77 D' }], numbers: { neh: 289 } },
  // ---- General praise ----
  { id: 'praise-to-the-lord', title: 'Praise to the Lord, the Almighty', firstLine: 'Praise to the Lord, the Almighty, the King of creation', verses: 4, seasons: [], congregations: [], tunes: [{ id: 'lobe-den-herren', name: 'Lobe den Herren', metre: '14.14.4.7.8', listenUrl: 'https://hymnary.org/tune/lobe_den_herren' }], numbers: { neh: 440, mp: 564 } },
  { id: 'praise-my-soul', title: 'Praise, my soul, the King of heaven', firstLine: 'Praise, my soul, the King of heaven', verses: 4, seasons: [], congregations: [], tunes: [{ id: 'lauda-anima', name: 'Lauda Anima (Goss)', metre: '87.87.87' }], numbers: { neh: 436, mp: 560 } },
  { id: 'love-divine', title: 'Love divine, all loves excelling', firstLine: 'Love divine, all loves excelling', verses: 3, seasons: [], congregations: [], tunes: [{ id: 'blaenwern', name: 'Blaenwern', metre: '87.87 D' }, { id: 'love-divine-stainer', name: 'Love Divine (Stainer)', metre: '87.87' }], numbers: { neh: 408, mp: 449 } },
  ...
  { id: 'guide-me', title: 'Guide me, O thou great Redeemer', firstLine: 'Guide me, O thou great Redeemer', verses: 3, seasons: [], congregations: [], tunes: [{ id: 'cwm-rhondda', name: 'Cwm Rhondda', metre: '87.87.47', listenUrl: 'https://hymnary.org/tune/cwm_rhondda' }], numbers: { neh: 368, mp: 201 } },
  { id: 'immortal-invisible', title: 'Immortal, invisible, God only wise', firstLine: 'Immortal, invisible, God only wise', verses: 4, seasons: [], congregations: [], tunes: [{ id: 'st-denio', name: 'St Denio', metre: '11.11.11.11' }], numbers: { neh: 377, mp: 327 } },
  { id: 'all-people-that-on-earth', title: 'All people that on earth do dwell', firstLine: 'All people that on earth do dwell', verses: 5, seasons: [], congregations: ['traditional', 'cathedral', 'small-rural'], tunes: [{ id: 'old-hundredth', name: 'Old Hundredth', metre: 'LM', listenUrl: 'https://hymnary.org/tune/old_hundredth' }], numbers: { neh: 334, mp: 20 } },
  { id: 'be-thou-my-vision', title: 'Be thou my vision', firstLine: 'Be thou my vision, O Lord of my heart', verses: 5, seasons: [], congregations: [], tunes: [{ id: 'slane', name: 'Slane', metre: '10.10.10.10' }], numbers: { neh: 339, mp: 58 } },
  ...
  { id: 'lord-of-all-hopefulness', title: 'Lord of all hopefulness', firstLine: 'Lord of all hopefulness, Lord of all joy', verses: 4, seasons: [], congregations: [], tunes: [{ id: 'slane-hopefulness', name: 'Slane', metre: '10.11.11.12' }], numbers: { neh: 239, mp: 442 } },
  ...
  { id: 'now-thank-we-all', title: 'Now thank we all our God', firstLine: 'Now thank we all our God', verses: 3, seasons: [], congregations: [], tunes: [{ id: 'nun-danket', name: 'Nun danket', metre: '67.67.66.66' }], numbers: { neh: 413, mp: 486 } },
  { id: 'great-is-thy-faithfulness', title: 'Great is thy faithfulness', firstLine: 'Great is thy faithfulness, O God my Father', verses: 3, hasChorus: true, seasons: [], congregations: [], tunes: [{ id: 'faithfulness', name: 'Faithfulness', metre: '11.10.11.10', listenUrl: 'https://hymnary.org/tune/faithfulness_runyan' }], numbers: { mp: 200, hon: 181 } },
  // ---- Evening ----
  { id: 'abide-with-me', title: 'Abide with me', firstLine: 'Abide with me; fast falls the eventide', verses: 5, seasons: [], congregations: [], tunes: [{ id: 'eventide', name: 'Eventide (Monk)', metre: '10.10.10.10', listenUrl: 'https://hymnary.org/tune/eventide_monk' }], numbers: { neh: 331, mp: 4 } },
